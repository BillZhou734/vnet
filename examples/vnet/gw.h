 ...
 * @return handle
 */
struct doca_gw_pipelne_entry *gw_pipeline_add_ol_to_ul_entry(struct doca_pkt_info *pinfo, struct doca_flow_pipeline *pipeline);
 ...
 * @return 
 */
struct doca_gw_pipelne_entry *gw_pipeline_add_ol_to_ol_entry(struct doca_pkt_info *pinfo, struct doca_flow_pipeline *pipeline);
